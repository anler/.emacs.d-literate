...
* Table of Contents                                                     :TOC:
 ...
 - [[#general][General]]
     ...
     - [[#better-help-with-discoverel-and-guide-key][Better help with discover.el and guide-key]]
 ...
 - [[#dired][Dired]]
     ...
     - [[#activate-ggtags-on-projects][Activate ggtags on projects]]
 ...
 - [[#key-bindings][Key bindings]]
     ...
     - [[#kill-sexp-backwards][Kill Sexp backwards]]
     - [[#expand-region][Expand region]]
     ...
     - [[#run-last-eshell-command][Run last eshell command]]
...
#+BEGIN_SRC elisp
  ...
  (defun set-common-pairs (mode-map)
    (add-hook 'post-self-insert-hook #'common-electric-pair-string-delimiter 'append t)
...
#+BEGIN_SRC elisp
  ...
  (setq themes-list (cycle '(django noctilux subatomic leuven)))
  ...
  (defun my/enable-theme (theme)
    ...
    (set-default-font "Fantasque Sans Mono-15" :keep-size))
...
#+BEGIN_SRC elisp
  (add-hook 'prog-mode-hook (lambda ()
                              (emr-initialize)
                              (local-set-key (kbd "M-RET") 'emr-show-refactor-menu)))
#+END_SRC
...
#+BEGIN_SRC elisp
  ...
  (global-set-key (kbd "s-w") 'smart-window-move)
  (global-set-key (kbd "C-M-2") 'smart-window-buffer-split)
  (global-set-key (kbd "s-M-2") 'smart-window-file-split)
#+END_SRC
