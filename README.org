...
#+BEGIN_SRC elisp
  ...
  (setq themes-list (cycle '(noctilux subatomic leuven)))
  ...
  (defun my/enable-theme (theme)
    ...
    (setq default-frame-alist '((font . "Fantasque Sans Mono-15"))))
...
#+BEGIN_SRC elisp
    (defun setup-python-mode ()
      ...
      (add-hook 'post-self-insert-hook #'python-electric-pair-string-delimiter 'append t)
